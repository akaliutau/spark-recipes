...
public class TransformationAndActionApp {
    ...
    private void start(String mode) {
        ...
        SparkSession spark = SparkSession.builder().appName("Analysing Catalyst's behavior").master("local").getOrCreate();
        long t1 = System.currentTimeMillis();
        log.info("1. Creating a session ...........{}", (t1 - t0));
        ...
        log.info("2. Loading initial dataset ......{}", (t2 - t1));
        ...
        if (mode.compareToIgnoreCase("noop") != 0) {
            ...
            if (mode.compareToIgnoreCase("full") == 0) {
                df = df.drop(df.col("avg")).drop(df.col("lcl2")).drop(df.col("ucl2"));
            }
        }
        long t5 = System.currentTimeMillis();
        log.info("5. Transformations  ............. {}", (t5 - t4));

        // Step 6 - Action
        df.collect();
        long t6 = System.currentTimeMillis();
        log.info("6. Final action ................. {}", (t6 - t5));

        log.info("");
        log.info("# of records .................... {}", df.count());
    }
}
